      ...
      sections={[
          ...
          blocks: [
            {
              ...
              items: [
                ...
                "SER-ECF makes reasonable efforts to direct designated gifts to the indicated ministry; however, where a designated need is fully met or no longer applicable, funds may be redirected to similar ministry priorities.",
        ...
        },
        {
          ...
          blocks: [
            {
              kind: "paragraph",
              text: "Affiliated ministries, theological colleges, seminaries, fellowships, counseling ministries, humanitarian programs, and training centers operating within the SER-ECF jurisdiction are governed by SER-ECF's Protocol Regulation for Ministries, Spiritual Institutions, and Theological Colleges.",
            },
            {
              kind: "callout",
